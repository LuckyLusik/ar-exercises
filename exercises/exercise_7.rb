...
store = Store.create(name: user_answer)
...
#   * BONUS: Stores must carry at least one of the men's
#     or women's apparel (hint: use a [custom validation method]
...
#     to the user (one on each line) after you attempt to save/create the record